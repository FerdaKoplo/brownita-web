        ...
        <div class="bg-white shadow-xl rounded-2xl p-8 w-full max-w-2xl">
            ...
            <form method="POST" action="{{ route('dashboard.admin.katalog.store') }}" enctype="multipart/form-data" id="kategoriForm" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" placeholder="Masukkan nama produk" id="nama_produk" name="nama_produk" class="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-lg py-2 px-3 text-gray-800 focus:ring-2 focus:ring-amber-700 focus:outline-none">
                </div>
                ...
                <div>
                    ...
                    <textarea placeholder="Masukkan deskripsi produk" id="deskripsi" name="deskripsi" rows="4" class="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-lg py-2 px-3 text-gray-800 focus:ring-2 focus:ring-amber-700 focus:outline-none"></textarea>
                </div>
