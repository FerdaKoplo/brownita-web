<div class="min-h-screen flex items-center bg-white justify-center mt-16 px-8 py-12">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-40 max-w-6xl w-full items-center">
        ...
        <div class="max-w-[500px]  w-full grid grid-cols-2 gap-2 rounded-xl border border-amber-700 p-2 bg-amber-700">
            <img src="{{ asset('images/bundt-cakes.png') }}" alt="Kue" class="object-cover w-full h-full rounded-md">
            <div class="grid grid-rows-2 gap-2">
                <img src="{{ asset('images/snacks.png') }}" alt="Snack" class="object-cover w-full h-full rounded-md">
