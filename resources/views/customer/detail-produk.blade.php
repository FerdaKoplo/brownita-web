    ...
    <div class="flex flex-col gap-12">
        ...
        <div class="border-2 border-brand-dark p-12 rounded-xl flex items-center justify-center gap-20">
            ...
            <div class="flex flex-col gap-7">
                ...
                @if (Auth::check())
                <div class="flex flex-col gap-5">
                    <button class="btn-wa bg-brand-dark w-full py-2 text-brand-light rounded-full"
                        data-wa-nama="{{ $produk->nama_produk }}"
                        data-wa-kategori="{{ $produk->category->nama_kategori ?? 'Kategori Tidak Diketahui' }}"
                        data-wa-harga="{{ $produk->harga_rupiah }}"
                        data-wa-deskripsi="{{ $produk->deskripsi }}">
                        Order
                    </button>
...
{{-- Include WhatsApp order popup --}}
@include('components.customer.whatsapp.whatsapp-order')
