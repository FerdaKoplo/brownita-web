...
@section('content')
    <div class="px-4 md:px-12 lg:px-32  md:pt-10 ">
        <div class="flex flex-col gap-12">
            ...
            <div
                class="border-2 border-black p-6 md:p-12 rounded-xl flex flex-col md:flex-row items-center md:items-start justify-center gap-8 md:gap-20">
                @php
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="flex items-end gap-5">
                            ...
                            <div class="flex flex-col gap-5">
                                <button
                                    class="text-2xl sm:text-3xl rounded-xl hover:bg-black transition bg-amber-700 text-white px-3 py-1 sm:px-4 sm:py-2"
                                    id="button-left">
                ...
                <div class="flex flex-col gap-7 w-full md:w-auto">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <p id="deskripsi-lengkap-{{ $produk->id }}"
                            class="hidden text-base sm:text-lg md:text-xl italic text-black max-w-lg">
                            {{ $produk->deskripsi }}
                        </p>
                    </div>
