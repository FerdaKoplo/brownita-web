...
@section('content')
    <div class="px-32">
        <div class="flex flex-col gap-12">
            ...
            <div class="border-2 border-black p-12 rounded-xl flex items-center justify-center gap-20">
                @php
                    ...
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <div class="flex items-end gap-5">
                            ...
                            <div class="flex flex-col gap-5 ">
                                <button class="text-3xl rounded-xl hover:bg-black transition bg-amber-700 text-white px-4 py-2 "
                                    id="button-left">
                ...
                <div class="flex flex-col gap-7">
                    ...
                    <h1 class="text-gray-800 font-bold text-6xl">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <p id="deskripsi-{{ $produk->id }}" class="text-xl italic text-black">
                            {{ Str::limit($produk->deskripsi, 60, '...') }}
                        </p>
                        <button onclick="toggleDeskripsi({{ $produk->id }})"
                            class=" italic flex items-end justify-end text-xl text-black font-bold mt-1">
                            Lihat Lebih
                        </button>
                        <p id="deskripsi-lengkap-{{ $produk->id }}" class="hidden text-xl italic text-black max-w-lg">
                            {{ $produk->deskripsi }}
                        </p>
                    </div>
                    ...
                    @if (Auth::check())
                        <div class="flex flex-col gap-5">
                            ...
                            <form action="{{ route('keranjang.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
                                ...
                                <button type="submit" class="border-2 hover:text-white hover:bg-gray-800 border-gray-800 w-full py-2 text-gray-800 transition  rounded-full">
